...
#this login function
#this login function is not full
'''
shu yerda chala joyi bor, modellarim Login model va user model
u yerdan ma'lumotlar olinishi va berilishi kerak
'''
class Login(View):
    return_url = None
    def get(self,request):
...
class Signup(View):
    ...
    def validateCustomer(self,customer):
        ...
        if (not customer.first_name):
            ...
            error_message = "Phone must be 5 char long or more"
            ...
            error_message = "Email Address Already Registreted!"
